...
def test_guest_can_go_to_login_page(browser):
    ...
    login_page = LoginPage(browser, browser.current_url) # инициализируем Login Object, передаем в конструктор экземпляр драйвера и url адрес 
    login_page.should_be_login_page()# проверка страницы Автоаризации